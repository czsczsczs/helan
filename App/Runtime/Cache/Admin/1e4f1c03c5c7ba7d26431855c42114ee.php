                    ...
                    <div class="xs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" action="<?php echo U('Slide/update');?>" method="post">
                                    <input type="hidden" name="id" value="<?php echo ($slide['id']); ?>">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput">標題</label>
                                        <div class="col-sm-6">
                                            <input class="form-control1" id="title" name="title" type="text" value="<?php echo ($slide['title']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group filled">
                                        <label class="col-sm-2 control-label" for="focusedinput">跳轉url</label>
                                        <div class="col-sm-6">
                                                <input class="form-control1" id="url" name="url" type="text" value="<?php echo ($slide['url']); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-2">
                                          ...
                                          <input type="hidden" name="image" id="cover" value="<?php echo ($slide["image"]); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            發佈&nbsp;&nbsp;<input name="status" type="radio" <?php if($slide['status'] == 'published'): ?>checked="checked"<?php endif; ?> value="published">&nbsp;&nbsp;&nbsp;&nbsp;草稿&nbsp;&nbsp;<input name="status" <?php if($slide['status'] == 'draft'): ?>checked="checked"<?php endif; ?>  type="radio" value="draft">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            是&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($slide['recommend'] == 1): ?>checked="checked"<?php endif; ?> value="1">&nbsp;&nbsp;&nbsp;&nbsp;否&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($slide['recommend'] == 0): ?>checked="checked"<?php endif; ?> value="0">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
