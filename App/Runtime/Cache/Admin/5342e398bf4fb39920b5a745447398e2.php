                    ...
                    <div class="xs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" action="<?php echo U('Posts/update');?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                           <select class="form-control select2" name="street_id" ng-model="model.select" required="">
                                                ...
                                                <?php if(is_array($street)): $i = 0; $__LIST__ = $street;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option <?php if($row['id'] == $post['street_id']): ?>selected<?php endif; ?> value="<?php echo ($row['id']); ?>"><?php echo ($row['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="title" name="title" type="text" value="<?php echo ($post['title']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="description" name="description" type="text" value="<?php echo ($post['description']); ?>">
                                        </div>
                                    ...
                                    <div class="form-group" id="editor">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <!-- 编辑器容器 -->
                                            <script id="content" name="content" type="text/plain" style="height: 500px"><?php echo (htmlspecialchars_decode($post['content'])); ?></script>
                                        </div>
                                        <!-- 实例化编辑器 -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="business_hours" name="business_hours" type="text" value="<?php echo ($post['business_hours']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="address" name="address" type="text" value="<?php echo ($post['address']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="latitude" name="latitude" type="text" value="<?php echo ($post['latitude']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput">lng(經度)</label>
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="longitude" name="longitude" type="text" value="<?php echo ($post['longitude']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-2">
                                          ...
                                          <input type="hidden" name="cover" id="cover" value="<?php echo ($post["cover"]); ?>">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            發佈&nbsp;&nbsp;<input name="status" type="radio" <?php if($post['status'] == 'published'): ?>checked="checked"<?php endif; ?> value="published">&nbsp;&nbsp;&nbsp;&nbsp;草稿&nbsp;&nbsp;<input name="status" <?php if($post['status'] == 'draft'): ?>checked="checked"<?php endif; ?>  type="radio" value="draft">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            是&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($post['recommend'] == 1): ?>checked="checked"<?php endif; ?> value="1">&nbsp;&nbsp;&nbsp;&nbsp;否&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($post['recommend'] == 0): ?>checked="checked"<?php endif; ?> value="0">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
