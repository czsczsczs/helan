                    ...
                    <div class="xs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" action="<?php echo U('Shop/update');?>" method="post">
                                    <input type="hidden" name="id" value="<?php echo ($shop['id']); ?>">
                                    <input type="hidden" name="type" value="<?php echo ($shop['type']); ?>">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput">所屬街道*</label>
                                        <div class="col-sm-8">
                                           <select class="form-control select2" name="street_id" ng-model="model.select" required="">
                                                <option value="">請選擇</option>
                                                <?php if(is_array($street)): $i = 0; $__LIST__ = $street;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option <?php if($row['id'] == $shop['street_id']): ?>selected<?php endif; ?> value="<?php echo ($row['id']); ?>"><?php echo ($row['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="title" name="title" type="text" value="<?php echo ($shop['title']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="description" name="description" type="text" value="<?php echo ($shop['description']); ?>">
                                        </div>
                                    ...
                                    <div class="form-group" id="editor">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <!-- 编辑器容器 -->
                                            <script id="content" name="content" type="text/plain" style="height: 500px"><?php echo (htmlspecialchars_decode($shop['content'])); ?></script>
                                        </div>
                                        <!-- 实例化编辑器 -->

                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput">開店時間</label>
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="business_hours" name="business_hours" type="text" value="<?php echo ($shop['business_hours']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput">電話</label>
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="phone" name="phone" type="text" value="<?php echo ($shop['phone']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="address" name="address" type="text" value="<?php echo ($shop['address']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="latitude" name="latitude" type="text" value="<?php echo ($shop['latitude']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="longitude" name="longitude" type="text" value="<?php echo ($shop['longitude']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-2">
                                          <div class="cover-box">
                                              <div class="c-box">
                                                <img src="<?php echo ($shop["cover"]); ?>">
                                              </div>
                                          </div>
                                          <input type="hidden" name="cover" id="cover" value="<?php echo ($shop["cover"]); ?>">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            發佈&nbsp;&nbsp;<input name="status" type="radio" <?php if($shop['status'] == 'published'): ?>checked="checked"<?php endif; ?> value="published">&nbsp;&nbsp;&nbsp;&nbsp;草稿&nbsp;&nbsp;<input name="status" <?php if($shop['status'] == 'draft'): ?>checked="checked"<?php endif; ?>  type="radio" value="draft">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            是&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($shop['recommend'] == 1): ?>checked="checked"<?php endif; ?> value="1">&nbsp;&nbsp;&nbsp;&nbsp;否&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($shop['recommend'] == 0): ?>checked="checked"<?php endif; ?> value="0">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
