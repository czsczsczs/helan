                ...
                <div class="mailbox-content">
                    ...
                    <div class="mail-toolbar clearfix">
                        ...
                        <div class="dropdown" style="padding-left:20px; ">
                            <a href="<?php echo U('Posts/add');?>"><button type="button" class="btn btn-info">新增</button></a>
                            <a href="<?php echo U('Posts/index');?>"><button type="button" class="btn btn-info">列表</button></a>
                        </div>
                        <div class="clearfix"> </div>
                        <br/>
                        <form class="bs-docs-example" novalidate="novalidate" ng-submit="submit()" action="<?php echo U('Posts/index');?>" method="get">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                          <select name="street_id" class="form-control select2">
                            <option selected="selected" value="">選擇街道</option>
                        ...
                        <div class="col-md-2"><input type="text" class="form-control1" name="keyword" value="<?php echo ($keyword); ?>" placeholder="請輸入關鍵字進行搜索"></div>
                        <div class="col-md-2"><button type="submit" class="btn btn-info">篩選</button>&nbsp;&nbsp;<a class="btn btn-info" href="<?php echo U('Posts/index');?>">撤銷</a></div>
                        <div class="col-md-2">共 <span style="color: blue;"><?php echo ($count); ?> </span>條記錄</div>
                    </form>
                   </div>
                    <table class="table">
                        <thead>
                        ...
                        <tbody>
                          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr class="unread checked">
                                ...
                                <div class="dropdown">
                                  ...
                                  <a href="<?php echo U('Posts/edit',array('id'=>$row['id']));?>"><button type="button" class="btn btn-warning warning_22">修改</button></a>
                                  <a onclick="deleted(<?php echo ($row['id']); ?>)"><button type="button" class="btn btn-danger">刪除</button></a>
                                  <!-- <a href="<?php echo U('Posts/add_en',array('id'=>$row['id']));?>" title="編輯英文信息"><button type="button" class="btn btn-info">編輯英文信息</button></a> -->
                                </div>
                                </td>
...
<script>
    ...
    function recommend(id) {
            ...
            $.ajax({
                url: "<?php echo U('Posts/recommend');?>",
                type: "post",
                dataType: "json",
                data: {id: id},
                success: function (msg) {
