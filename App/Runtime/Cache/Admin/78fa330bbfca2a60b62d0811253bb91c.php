                    ...
                    <div class="xs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" action="<?php echo U('StreetHistory/update');?>" method="post">
                                    <input type="hidden" name="id" value="<?php echo ($streetHistory['id']); ?>">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                           <select class="form-control select2" name="street_id" ng-model="model.select" required="">
                                                ...
                                                <?php if(is_array($street)): $i = 0; $__LIST__ = $street;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option <?php if($row['id'] == $streetHistory['street_id']): ?>selected<?php endif; ?> value="<?php echo ($row['id']); ?>"><?php echo ($row['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="title" name="title" type="text" value="<?php echo ($streetHistory['title']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="description" name="description" type="text" value="<?php echo ($streetHistory['description']); ?>">
                                        </div>
                                    ...
                                    <div class="form-group" id="editor">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <!-- 编辑器容器 -->
                                            <script id="content" name="content" type="text/plain" style="height: 500px"><?php echo (htmlspecialchars_decode($streetHistory['content'])); ?></script>
                                        </div>
                                        <!-- 实例化编辑器 -->
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput"  required="">排序</label>
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="sort" name="sort" type="text" value="<?php echo ($streetHistory['sort']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-2">
                                          <div class="cover-box">
                                              <div class="c-box">
                                                <img src="<?php echo ($streetHistory["cover"]); ?>">
                                              </div>
                                          </div>
                                          <input type="hidden" name="cover" id="cover" value="<?php echo ($streetHistory["cover"]); ?>">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            發佈&nbsp;&nbsp;<input name="status" type="radio" <?php if($streetHistory['status'] == 'published'): ?>checked="checked"<?php endif; ?> value="published">&nbsp;&nbsp;&nbsp;&nbsp;草稿&nbsp;&nbsp;<input name="status" <?php if($streetHistory['status'] == 'draft'): ?>checked="checked"<?php endif; ?>  type="radio" value="draft">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            是&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($streetHistory['recommend'] == 1): ?>checked="checked"<?php endif; ?> value="1">&nbsp;&nbsp;&nbsp;&nbsp;否&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($streetHistory['recommend'] == 0): ?>checked="checked"<?php endif; ?> value="0">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
