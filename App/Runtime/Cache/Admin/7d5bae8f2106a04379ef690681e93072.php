            ...
            <div class="mailbox-content">
              <?php if($ext_user['is_admin'] == 1): ?><div class="mail-toolbar clearfix">
                     <div class="float-left">
                        <div class="dropdown">
                          <a href="<?php echo U('Admin/add');?>"><button type="button" class="btn btn-info">新增</button></a>
                        </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr class="unread checked">
                            ...
                            <td>
                                <div class="dropdown">
                                  <?php if($ext_user['is_admin'] != 1): if($ext_user['is_admin'] == $row['is_admin'] ): ?><a href="<?php echo U('Admin/edit',array('id'=>$row['id']));?>"><button type="button" class="btn btn-info">查看編輯</button></a>

                                      <a onclick="deleted(<?php echo ($row['id']); ?>)"><button type="button" class="btn btn-danger">刪除</button></a><?php endif; ?>
                               <?php else: ?>
                                <a href="<?php echo U('Admin/edit',array('id'=>$row['id']));?>"><button type="button" class="btn btn-info">查看編輯</button></a>
