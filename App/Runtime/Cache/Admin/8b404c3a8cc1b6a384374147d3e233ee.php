                    ...
                    <div class="xs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" action="<?php echo U('News/update');?>" method="post">
                                    <input type="hidden" name="id" value="<?php echo ($news['id']); ?>">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput">標題*</label>
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="title" name="title" type="text" value="<?php echo ($news['title']); ?>">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="description" name="description" type="text" value="<?php echo ($news['description']); ?>">
                                        </div>
                                    ...
                                    <div class="form-group" id="editor">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <!-- 编辑器容器 -->
                                            <script id="content" name="content" type="text/plain" style="height: 500px"><?php echo (htmlspecialchars_decode($news['content'])); ?></script>
                                        </div>
                                        <!-- 实例化编辑器 -->
                                    ...
                                    <div class="form-group filled">
                                        ...
                                        <div class="col-sm-8">
                                                <input class="form-control1" id="other" name="other" type="text" value="<?php echo ($news['other']); ?>">
                                        </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-2">
                                          <div class="cover-box">
                                              <div class="c-box">
                                                <img src="<?php echo ($news["cover"]); ?>">
                                              </div>
                                          </div>
                                          <input type="hidden" name="cover" id="cover" value="<?php echo ($news["cover"]); ?>">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            發佈&nbsp;&nbsp;<input name="status" type="radio" <?php if($news['status'] == 'published'): ?>checked="checked"<?php endif; ?> value="published">&nbsp;&nbsp;&nbsp;&nbsp;草稿&nbsp;&nbsp;<input name="status" <?php if($news['status'] == 'draft'): ?>checked="checked"<?php endif; ?>  type="radio" value="draft">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            是&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($news['recommend'] == 1): ?>checked="checked"<?php endif; ?> value="1">&nbsp;&nbsp;&nbsp;&nbsp;否&nbsp;&nbsp;<input name="recommend" type="radio" <?php if($news['recommend'] == 0): ?>checked="checked"<?php endif; ?> value="0">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
