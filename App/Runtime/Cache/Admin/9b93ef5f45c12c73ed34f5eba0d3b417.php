                    ...
                    <div class="xs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="horizontal-form">
                                <form class="form-horizontal" action="<?php echo U('StreetHistory/create');?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="focusedinput"  required="">標題*</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control1" id="sort" name="sort" type="text">
                                        </div>
                                        <div class="col-sm-2">
                                            <p class="help-block">
