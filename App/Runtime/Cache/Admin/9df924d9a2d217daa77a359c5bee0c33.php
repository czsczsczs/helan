...
<!--             <div class="col-md-4 span_8">
               <div class="activity_box">
                <div class="scrollbar" id="style-2">
                    <div class="activity-row">
                     ...
                     <div class="col-xs-3 activity-img"><img src='/Public/Static/Admin/images/3.png' class="img-responsive" alt=""/></div>
                    ...
                    <div class="activity-row">
                     ...
                     <div class="col-xs-3 activity-img"><img src='/Public/Static/Admin/images/1.png' class="img-responsive" alt=""/></div>
                     <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
                     ...
                     <div class="col-xs-3 activity-img"><img src='/Public/Static/Admin/images/4.png' class="img-responsive" alt=""/></div>
                     <div class="col-xs-8 activity-desc">
      ...
      <div class="span_11">
        <div class="col-md-6 col_4">
          <!----Calender -------->
            <link rel="stylesheet" href="/Public/Static/Admin/css/clndr.css" type="text/css" />
            <script src="/Public/Static/Admin/js/underscore-min.js" type="text/javascript"></script>
            <script src="/Public/Static/Admin/js/moment-2.2.1.js" type="text/javascript"></script>
            <script src="/Public/Static/Admin/js/clndr.js" type="text/javascript"></script>
            <script src="/Public/Static/Admin/js/site.js" type="text/javascript"></script>
            <!----End Calender -------->
        </div>
