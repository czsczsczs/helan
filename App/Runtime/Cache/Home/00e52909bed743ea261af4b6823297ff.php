...
<style type="text/css">
    ...
    <div class="fullwidthabnner">
        <ul>
            <?php if(is_array($slide)): $i = 0; $__LIST__ = $slide;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$slide_row): $mod = ($i % 2 );++$i;?><li data-transition="slideleft" data-slotamount="1" data-masterspeed="300" data-thumb="/Public/Static/Home/img/sliders/revolution/thumbs/thumb1.jpg">
            	<a href="<?php echo ($slide_row['url']); ?>" target="_blank">
            		<img src="<?php echo ($slide_row['image']); ?>" />
            	</a>
	...
	<div class="container">
		...
		<div class="index-activity">
			<div class="headline">
				<h3><a href="https://www.hollandshow.cn/Active/index.html">巡禮活動</a></h3>
			</div>
			<div class="swiper-container swiper-con-activity">
				<ul class="thumbnails swiper-wrapper ulc">
					<?php if(is_array($active)): $i = 0; $__LIST__ = $active;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$active_row): $mod = ($i % 2 );++$i;?><li class="swiper-slide" link="<?php echo U('Active/detail',array('id'=>$active_row['id']));?>">
						<div class="thumbnail-style" style="height: 335px;">
							<div class="thumbnail-img">
								<div class="overflow-hidden imgsize">
									<img src="<?php echo ($active_row['cover_width_300']); ?>" alt="" />
								</div>
		...
		<div class="index-activity">
			<div class="headline">
				<h3><a href="https://www.hollandshow.cn/News/index.html">新聞資訊</a></h3>
			</div>
			<div class="swiper-container swiper-con-activity">
				<ul class="thumbnails swiper-wrapper ulc">
					<?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><li class="swiper-slide" link="<?php echo U('News/detail',array('id'=>$new['id']));?>">
						<div class="thumbnail-style">
							<div class="thumbnail-img">
								<div class="overflow-hidden imgsize">
									<img style="" src="<?php echo ($new['cover_width_300']); ?>" alt="" />
								</div>
		...
		<div class="index-activity">
			<div class="headline">
				<h3><a href="https://www.hollandshow.cn/StreetHistory/index.html">街道故事</a></h3>
			</div>
			<div class="swiper-container swiper-con-activity">
				<ul class="thumbnails swiper-wrapper ulc">
					<?php if(is_array($streetHistory)): $i = 0; $__LIST__ = $streetHistory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$streetHistory_row): $mod = ($i % 2 );++$i;?><li class="swiper-slide" link="<?php echo U('streetHistory/detail',array('id'=>$streetHistory_row['id']));?>">
						<div class="thumbnail-style">
							<div class="thumbnail-img">
								<div class="overflow-hidden imgsize">
									<img style="" src="<?php echo ($streetHistory_row['cover_width_300']); ?>" alt="" />
								</div>
	...
	<div class="container portfolio-item ">
		<!-- Recent Works -->
		<div class="headline">
			<h3><a href="https://www.hollandshow.cn/Posts/index.html">特色景點</a></h3>
		</div>
		<div class="row-fluid margin-bottom-40 swiper-container swiper-con-scenic">
			<ul class="bxslider recent-work swiper-wrapper ulc">
				<?php if(is_array($post)): $i = 0; $__LIST__ = $post;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p_row): $mod = ($i % 2 );++$i;?><li class="swiper-slide" link="<?php echo U('Posts/detail',array('id'=>$p_row['id']));?>">
					<div class="thumbnail-style">
						<a href="<?php echo U('Posts/detail',array('id'=>$p_row['id']));?>">
							...
							<em class="overflow-hidden imgsize">
								<img src="<?php echo ($p_row['cover_width_300']); ?>" alt="" />
							</em>
						</a>
						<!-- <span>
	...
	<div class="container portfolio-item ">
		<!-- Recent Works -->
		<div class="headline">
			<h3><a href="https://www.hollandshow.cn/Shop/index.html">社區美食</a></h3>
		</div>
		<div class="row-fluid margin-bottom-40 swiper-container swiper-con-scenic">
			<ul class="bxslider recent-work swiper-wrapper ulc">
				<?php if(is_array($shop)): $i = 0; $__LIST__ = $shop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s_row): $mod = ($i % 2 );++$i;?><li class="swiper-slide" link="<?php echo U('Shop/detail',array('id'=>$s_row['id']));?>">
					<div class="thumbnail-style">
						<a href="<?php echo U('Shop/detail',array('id'=>$s_row['id']));?>">
							<em class="overflow-hidden imgsize">
								<img src="<?php echo ($s_row['cover_width_300']); ?>" alt="" />
							</em>
						</a>
						<!-- <span>
	...
	<div class="index-activity">
    			<div class="headline">
    				<h3><a href="https://www.hollandshow.cn/Media/index.html">圖片集</a></h3>
    			</div>
    			<div class="swiper-container swiper-con-activity">
    				<ul class="thumbnails swiper-wrapper ulc">
    					<?php if(is_array($media)): $i = 0; $__LIST__ = $media;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$media): $mod = ($i % 2 );++$i;?><li class="swiper-slide" link="<?php echo U('Media/detail',array('id'=>$media['id']));?>">
    						<div class="thumbnail-style">
    							<div class="thumbnail-img">
    								<div class="overflow-hidden imgsize">
    									<img style="" src="<?php echo ($media['cover_width_300']); ?>" alt="" />
    								</div>
    								<a class="btn-more hover-effect" href="<?php echo U('Media/detail',array('id'=>$media['id']));?>">查看詳情+</a>
    							</div>
    							<h3 id="index_overflow" title="<?php echo ($media['title']); ?>" >
    								<a class="hover-effect" href="<?php echo U('Media/detail',array('id'=>$media['id']));?>"><?php echo ($media['title']); ?></a>
    							</h3>
    							<p></p>
    						</div>
    					</li><?php endforeach; endif; else: echo "" ;endif; ?>
    		...
    		<div class="index-activity">
                			<div class="headline">
                				<h3><a href="https://www.hollandshow.cn/Media2/index.html">視頻集</a></h3>
                			</div>
                			<div class="swiper-container swiper-con-activity">
                				<ul class="thumbnails swiper-wrapper ulc">
                					<?php if(is_array($media2)): $i = 0; $__LIST__ = $media2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$media2): $mod = ($i % 2 );++$i;?><li class="swiper-slide" link="<?php echo U('Media2/detail',array('id'=>$media2['id']));?>">
                						<div class="thumbnail-style">
                							<div class="thumbnail-img">
                								<div class="overflow-hidden imgsize">
                									<img style="" src="<?php echo ($media2['cover_width_300']); ?>" alt="" />
                								</div>
                								<a class="btn-more hover-effect" href="<?php echo U('Media2/detail',array('id'=>$media2['id']));?>">查看詳情+</a>
                							</div>
                							<h3 id="index_overflow" title="<?php echo ($media2['title']); ?>" >
                								<a class="hover-effect" href="<?php echo U('Media2/detail',array('id'=>$media2['id']));?>"><?php echo ($media2['title']); ?></a>
                							</h3>
                							<p></p>
                						</div>
                					</li><?php endforeach; endif; else: echo "" ;endif; ?>
