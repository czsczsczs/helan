...
<div class="breadcrumbs margin-bottom-20">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><a href="<?php echo U('Posts/index');?>">特色景點</a> <span class="divider">/</span></li>
    ...
    <div class="row-fluid blog-page portflio_details">
        ...
        <div class="span9">
            ...
            <ul class="unstyled" style="font-size: 16px">
                <li>
                    <span style="width:110px;display: inline-block;vertical-align: top;"><i class="icon-time color-green"></i> 開放時間：</span>
                    <span style="width:500px;display: inline-block;vertical-align: top;"><?php echo ($post['business_hours']); ?></span>
                </li>
                <li>
                    <span style="width:110px;display: inline-block;vertical-align: top;"><i class="icon-map-marker color-green"></i> 具體地址：</span>
                    <span style="width:500px;display: inline-block;vertical-align: top;"><?php echo ($post['address']); ?></span>
                </li>
            </ul>
            ...
            <div class="headdiv">
                <span  style="width: 100%;display: inline-block;">上一篇：
                    <?php if($before['title'] != NULL): ?><a href="<?php echo U(Posts/detail,array('id'=>$before['id']));?>" class="handover"><?php echo ($before['title']); ?></a>
                    <?php else: ?>
                        <a class="no">無</a><?php endif; ?>
                </span>
                <span>下一篇：
                    <?php if($later['title'] != NULL): ?><a href="<?php echo U(Posts/detail,array('id'=>$later['id']));?>" class="handover"><?php echo ($later['title']); ?></a>
                    <?php else: ?>
                        <a class="no">無</a><?php endif; ?>
                </span>
            </div>
