...
<div class="breadcrumbs margin-bottom-20">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            <li><a href="<?php echo U('Index/index');?>">首頁</a> <span class="divider">/</span></li>
            <li><a href="<?php echo U('Media/index');?>">圖片集</a> <span class="divider">/</span></li>
...
<div class="breadcrumbs margin-bottom-20">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            <li><a href="<?php echo U('Index/index');?>">首頁</a> <span class="divider">/</span></li>
            <li><a href="<?php echo U('Media2/index');?>">視頻集</a> <span class="divider">/</span></li>
            <li class="active"><?php echo ($media2['title']); ?></li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
