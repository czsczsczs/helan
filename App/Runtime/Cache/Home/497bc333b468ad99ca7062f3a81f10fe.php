...
<div class="breadcrumbs margin-bottom-40">
	<div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li class="#">搜索<span class="divider">/</span></li>
...
<div class="container">
	<div class="row-fluid">
        <div id="w">
            <ul class="thumbnails activity ulc">
                <?php if($search): if(is_array($search)): $i = 0; $__LIST__ = $search;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i; if($row['search_type'] == 'active'): ?><li class="span3" link="<?php echo U('Active/detail',array('id'=>$row['id']));?>">
                <?php elseif($row['search_type'] == 'history'): ?>
                <li class="span3" link="<?php echo U('StreetHistory/detail',array('id'=>$row['id']));?>">
                <?php elseif($row['search_type'] == 'posts'): ?>
                <li class="span3" link="<?php echo U('Posts/detail',array('id'=>$row['id']));?>">
                <?php elseif($row['search_type'] == 'shop'): ?>
                <li class="span3" link="<?php echo U('Shop/detail',array('id'=>$row['id']));?>"><?php endif; ?>
            		<div class="thumbnail-style thumbnail-kenburn">
            			<div class="thumbnail-img">
            				<div class="overflow-hidden imgsize"><img src="<?php echo ($row['cover']); ?>" alt="" /></div>

            			</div>
            			<h3 style=" white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
                            <?php if($row['search_type'] == 'active'): ?><a class="hover-effect" href="<?php echo U('Active/detail',array('id'=>$row['id']));?>" title="<?php echo ($row['title']); ?>"><?php echo ($row['title']); ?>
                            </a>
                            <?php elseif($row['search_type'] == 'history'): ?>
                            <a class="hover-effect" href="<?php echo U('StreetHistory/detail',array('id'=>$row['id']));?>" title="<?php echo ($row['title']); ?>"><?php echo ($row['title']); ?>
                            </a>
                            <?php elseif($row['search_type'] == 'posts'): ?>
                            <a class="hover-effect" href="<?php echo U('Posts/detail',array('id'=>$row['id']));?>" title="<?php echo ($row['title']); ?>"><?php echo ($row['title']); ?>
                            </a>
                            <?php elseif($row['search_type'] == 'shop'): ?>
                            <a class="hover-effect" href="<?php echo U('Shop/detail',array('id'=>$row['id']));?>" title="<?php echo ($row['title']); ?>"><?php echo ($row['title']); ?>
                            </a><?php endif; ?>

            			</h3>
                        <?php if($row['search_type'] == 'active'): ?><p>類型:活動</p>
                        <?php elseif($row['search_type'] == 'history'): ?>
                        <p>類型:街道歷史</p>
                        <?php elseif($row['search_type'] == 'posts'): ?>
                        <p>類型:景點</p>
                ...
                <?php else: ?>
                <p style="font-size: 30px;">找不到搜索結果</p><?php endif; ?>
            </ul><!--/thumbnails-->
        </div>
    </div><!--/row-fluid-->
</div><!--/container-->
