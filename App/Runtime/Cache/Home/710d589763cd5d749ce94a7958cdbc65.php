...
<div class="breadcrumbs margin-bottom-20">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><a href="<?php echo U('StreetHistory/index');?>">史話街道</a> <span class="divider">/</span></li>
            <li class="active"><?php echo ($history['title']); ?></li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
    ...
    <div class="row-fluid blog-page portflio_details">
        ...
        <div class="span9">
            <div class="blog margin-bottom-30">
                <h3 class="text-center"><?php echo ($history['title']); ?></h3>
                <!-- <div class="text-center">作者：</div> -->
                <div class="blog-img" style="font-size: 20px;"></div>
                    <p><?php echo (htmlspecialchars_decode($history['content'])); ?></p>
            ...
            <div class="headdiv">
                <span style="width: 100%;display: inline-block;">上一篇：
                    <?php if($before['title'] != NULL): ?><a href="<?php echo U(streetHistory/detail,array('id'=>$before['id']));?>" class="handover"><?php echo ($before['title']); ?></a>
                    <?php else: ?>
                        <a class="no">無</a><?php endif; ?>
                </span>
                <span>下一篇：
                    <?php if($later['title'] != NULL): ?><a href="<?php echo U(streetHistory/detail,array('id'=>$later['id']));?>" class="handover"><?php echo ($later['title']); ?></a>
                    <?php else: ?>
                        <a class="no">無</a><?php endif; ?>
                </span>
            </div>
