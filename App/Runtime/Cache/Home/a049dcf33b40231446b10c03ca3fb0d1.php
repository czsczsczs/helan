...
<div class="breadcrumbs margin-bottom-40">
	<div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li class="<?php echo U('Active/index');?>">社區活動</li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
	...
	<div class="row-fluid">
        <div id="w">
            <ul class="thumbnails activity ulc">
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><li class="span3" link="<?php echo U('Active/detail',array('id'=>$row['id']));?>" >
            		<div class="thumbnail-style thumbnail-kenburn" style="height: 335px;">
            			<div class="thumbnail-img">
            				<div class="overflow-hidden imgsize"><img src="<?php echo ($row['cover_width_300']); ?>" alt="" /></div>
            				<a class="btn-more hover-effect" href="<?php echo U('Active/detail',array('id'=>$row['id']));?>">閱讀更多+</a>
            			</div>
            			<h3 style=" white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
            				<a class="hover-effect" href="<?php echo U('Active/detail',array('id'=>$row['id']));?>" title="<?php echo ($row['title']); ?>"><?php echo ($row['title']); ?></a>
            			</h3>
                        <?php if($row['time']): ?><p style=" white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">活動時間：<?php echo ($row['time']); ?></p>
                        <?php else: ?>
                        <p>活動時間:無</p><?php endif; ?>
            			<p style=" white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">活動地點：<?php echo ($row['address']); ?></p>
            		</div>
